<x-jet-action-section>
    ...
    <x-slot name="description">
        Редактируйте Ваши сеансы на других устройствах и браузерах.
    </x-slot>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            ...
            Если необходимо, Вы можете выйти из всех браузеров среди всех Ваших устройств. Некоторые из Ваших последних сеансов перечислены внизу; хотя список может быть не полным. Если Вы считаете, что Ваш аккаунт скомпрометирован, Вам стоит обновить свой пароль.
        </div>

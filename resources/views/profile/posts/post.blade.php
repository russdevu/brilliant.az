      ...
      <div class="single-post_container">
          ...
          <div class="post post_s">
              <div class="post_slots">
                  <img class="post_slots-img--main"
                  src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}"
                  alt="{{$post->post_title}}">
                  <img class="post_slots-img"
                  src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}"
                  alt="{{$post->post_title}}">
                  <img class="post_slots-img" src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}" alt="{{$post->post_title}}">
                  <img class="post_slots-img" src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}" alt="{{$post->post_title}}">
                  <img class="post_slots-img" src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}" alt="{{$post->post_title}}">
                  <img class="post_slots-img" src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}" alt="{{$post->post_title}}">
                  <img class="post_slots-img" src="{{ asset('/storage/post_images/' . $post->user->id . '/' . $post->post_img) }}" alt="{{$post->post_title}}">
